...
class PacketManager
{
	...
	{
		_onRecv.Add((ushort)MsgId.SConnectedToServer, MakePacket<S_ConnectedToServer>);
		_handler.Add((ushort)MsgId.SConnectedToServer, PacketHandler.S_ConnectedToServerHandler);
